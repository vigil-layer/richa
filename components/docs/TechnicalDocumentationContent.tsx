...
import { Shield, FileText, Binary, Layers, Terminal, AlertCircle, Lock, Cpu, Target, ShieldAlert, Database, History, Fingerprint, Activity } from 'lucide-react';
    ...
    <div className="space-y-12 md:space-y-16 px-1 md:px-12 relative z-10">
      ...
      <DocCard border="blue" glow>
        ...
        <div className="space-y-8 md:space-y-10">
          ...
          <ClauseFrame id="VIG-ARCH-PREDICT">
        ...
        <div className="lg:col-span-7 space-y-8 md:space-y-12">
          ...
          <DocCard border="zinc">
            ...
            <div className="space-y-4 text-zinc-400 text-sm leading-relaxed font-medium">
              <p>Human intent in Web3 systems is primarily formed within web browsers. Users discover addresses through social platforms, block explorers, and dApp interfaces.</p>
            </div>
          </DocCard>
        </div>
